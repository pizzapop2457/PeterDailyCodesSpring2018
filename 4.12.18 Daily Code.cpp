...
int main(int argc, char **argv)
{
	...
	while (1)
	{
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {
			...
			else if (ev.mouse.x < 640 && ev.mouse.x > 320 && ev.mouse.y < 240) {
				al_draw_filled_rectangle(320, 0, 640, 240, al_map_rgb(rand() % 255, rand() % 255, rand() % 255));
			}
			else if (ev.mouse.y < 480 && ev.mouse.y > 240 && ev.mouse.x < 320) {
				al_draw_filled_rectangle(0, 240, 320, 480, al_map_rgb(rand() % 255, rand() % 255, rand() % 255));
			}
			else if (ev.mouse.x < 640 && ev.mouse.x > 320 && ev.mouse.y < 480 && ev.mouse.y > 240) {
